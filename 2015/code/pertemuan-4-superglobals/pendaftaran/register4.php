 ...
 *
 * Implementasi pendaftaran asisten, data didapat dari file daftar_asisten4.php
 * Redirect user kembali ke daftar_asisten4.php ketika ada kesalahan input data
...
if (!empty($_POST["nrp"]) || !empty($_POST["nama"]) || !empty($_POST["angkatan"]))
{
	...
	header("Location: http://localhost:8888/pw2/pertemuan-4a/pendaftaran/daftar_asisten4.php");
    exit;
}

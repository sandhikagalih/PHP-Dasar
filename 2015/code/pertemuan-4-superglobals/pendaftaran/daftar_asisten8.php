 ...
 * Mengirim data ke daftar_asisten8.php (ke halaman ini sendiri)
    ...
    <div style="text-align: center;">
      ...
      <form action="register8.php" method="post">
        <table style="border: 0; margin-left: auto; margin-right: auto; text-align: left">
          <tr>
            <td>NRP:</td>
            <td><input name="nrp" type="text" value="<?php if(isset($_POST["nrp"])) echo htmlspecialchars($_POST["nrp"]); ?>"></td>
          </tr>
          <tr>
            <td>Nama:</td>
